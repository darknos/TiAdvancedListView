...
@implementation TiAdvancedListViewListItem {
	TiAdvancedListViewListItemProxy *_proxy;
...
- (void)layoutSubviews
{
    ...
    } else if ([self.backgroundView isKindOfClass:[TiAdvancedListViewSelectedCellBackgroundView class]]) {
...
-(void) applyBackgroundWithSelectedColor:(id)selectedBackgroundColor selectedImage:(id)selectedBackgroundImage
{
    ...
    if (sbgImage != nil) {
        ...
        if (![self.selectedBackgroundView isKindOfClass:[TiAdvancedListViewSelectedCellBackgroundView class]]) {
            self.selectedBackgroundView = [[[TiAdvancedListViewSelectedCellBackgroundView alloc] initWithFrame:CGRectZero] autorelease];
        }
        TiAdvancedListViewSelectedCellBackgroundView *selectedBGView = (TiAdvancedListViewSelectedCellBackgroundView*)self.selectedBackgroundView;
