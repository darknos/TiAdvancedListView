...
@property (nonatomic, readonly) TiAdvancedListViewListViewProxy *listViewProxy;
@end
...
- (TiAdvancedListViewListViewProxy *)listViewProxy
{
	return (TiAdvancedListViewListViewProxy *)self.proxy;
}
...
-(TiUIView*)sectionView:(NSInteger)section forLocation:(NSString*)location section:(TiAdvancedListViewListSectionProxy**)sectionResult
{
    TiAdvancedListViewListSectionProxy *proxy = [self.listViewProxy sectionForIndex:section];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        TiAdvancedListViewListSectionProxy* theSection = [[self.listViewProxy sectionForIndex:indexPath.section] retain];
                ...
                if (needsReload) {
                    ...
                    [visibleRows enumerateObjectsUsingBlock:^(NSIndexPath *vIndexPath, NSUInteger idx, BOOL *stop) {
                        if (vIndexPath.section > indexPath.section) {
                            ...
                            if ([theCell isKindOfClass:[TiAdvancedListViewListItem class]]) {
                                ((TiAdvancedListViewListItem*)theCell).proxy.indexPath = newIndex;
                            }
                        }
                    }];
                }
...
- (void)tableView:(UITableView *)tableView moveRowAtIndexPath:(NSIndexPath *)fromIndexPath toIndexPath:(NSIndexPath *)toIndexPath
{
    ...
    if (fromSectionIndex == toSectionIndex) {
        ...
        TiAdvancedListViewListSectionProxy* theSection = [[self.listViewProxy sectionForIndex:fromSectionIndex] retain];
        ...
        TiAdvancedListViewListSectionProxy* fromSection = [[self.listViewProxy sectionForIndex:fromSectionIndex] retain];
        NSDictionary *theItem = [[fromSection itemAtIndex:fromRowIndex] retain];
        TiAdvancedListViewListSectionProxy* toSection = [[self.listViewProxy sectionForIndex:toSectionIndex] retain];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    if (_searchResults != nil) {
        ...
        TiAdvancedListViewListSectionProxy* theSection = [self.listViewProxy sectionForIndex:section];
        if (theSection != nil) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TiAdvancedListViewListSectionProxy* theSection = [self.listViewProxy sectionForIndex:realIndexPath.section];
    NSInteger maxItem = 0;
    ...
    TiAdvancedListViewListItem *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil) {
        id<TiEvaluator> context = self.listViewProxy.executionContext;
        if (context == nil) {
            context = self.listViewProxy.pageContext;
        }
        TiAdvancedListViewListItemProxy *cellProxy = [[TiAdvancedListViewListItemProxy alloc] initWithListViewProxy:self.listViewProxy inContext:context];
        if ([templateId isKindOfClass:[NSNumber class]]) {
            UITableViewCellStyle cellStyle = [templateId unsignedIntegerValue];
            cell = [[TiAdvancedListViewListItem alloc] initWithStyle:cellStyle reuseIdentifier:cellIdentifier proxy:cellProxy];
        } else {
            cell = [[TiAdvancedListViewListItem alloc] initWithProxy:cellProxy reuseIdentifier:cellIdentifier];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [(TiAdvancedListViewListItem*)cell configureCellBackground];
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    TiAdvancedListViewListSectionProxy *sectionProxy = [self.listViewProxy sectionForIndex:realSection];
...
- (void)fireClickForItemAtIndexPath:(NSIndexPath *)indexPath tableView:(UITableView *)tableView accessoryButtonTapped:(BOOL)accessoryButtonTapped
{
	...
	TiAdvancedListViewListSectionProxy *section = [self.listViewProxy sectionForIndex:indexPath.section];
	...
	TiAdvancedListViewListItem *cell = (TiAdvancedListViewListItem *)[tableView cellForRowAtIndexPath:indexPath];
