...
@interface TiAdvancedListViewListViewProxy ()
@property (nonatomic, readwrite) TiAdvancedListViewListView *listView;
@end
...
- (TiAdvancedListViewListView *)listView
{
	return (TiAdvancedListViewListView *)self.view;
}
...
- (void) deleteSectionAtIndex:(NSUInteger)index
{
    ...
    TiAdvancedListViewListSectionProxy *section = [_sections objectAtIndex:index];
...
- (void)setSections:(id)args
{
	...
	[insertedSections enumerateObjectsUsingBlock:^(TiAdvancedListViewListSectionProxy *section, NSUInteger idx, BOOL *stop) {
		ENSURE_TYPE(section, TiAdvancedListViewListSectionProxy);
		[self rememberProxy:section];
	}];
	[self dispatchBlock:^(UITableView *tableView) {
		[_sections enumerateObjectsUsingBlock:^(TiAdvancedListViewListSectionProxy *section, NSUInteger idx, BOOL *stop) {
			section.delegate = nil;
...
- (void)appendSection:(id)args
{
	...
	UITableViewRowAnimation animation = [TiAdvancedListViewListView animationStyleForProperties:properties];
	[appendedSections enumerateObjectsUsingBlock:^(TiAdvancedListViewListSectionProxy *section, NSUInteger idx, BOOL *stop) {
		ENSURE_TYPE(section, TiAdvancedListViewListSectionProxy);
		[self rememberProxy:section];
	}];
...
- (void)deleteSectionAt:(id)args
{
	...
	[self dispatchUpdateAction:^(UITableView *tableView) {
		...
		TiAdvancedListViewListSectionProxy *section = [_sections objectAtIndex:deleteIndex];
...
- (void)insertSectionAt:(id)args
{
	...
	UITableViewRowAnimation animation = [TiAdvancedListViewListView animationStyleForProperties:properties];
	[insertSections enumerateObjectsUsingBlock:^(TiAdvancedListViewListSectionProxy *section, NSUInteger idx, BOOL *stop) {
		ENSURE_TYPE(section, TiAdvancedListViewListSectionProxy);
		[self rememberProxy:section];
	}];
	[self dispatchUpdateAction:^(UITableView *tableView) {
...
- (void)replaceSectionAt:(id)args
{
	...
	TiAdvancedListViewListSectionProxy *section = [args objectAtIndex:1];
	ENSURE_TYPE_OR_NIL(section, TiAdvancedListViewListSectionProxy);
	NSDictionary *properties = [args count] > 2 ? [args objectAtIndex:2] : nil;
	UITableViewRowAnimation animation = [TiAdvancedListViewListView animationStyleForProperties:properties];
	[self rememberProxy:section];
	[self dispatchUpdateAction:^(UITableView *tableView) {
		...
		TiAdvancedListViewListSectionProxy *prevSection = [_sections objectAtIndex:replaceIndex];
...
- (void)scrollToItem:(id)args
{
	...
	[self dispatchUpdateAction:^(UITableView *tableView) {
		...
		TiAdvancedListViewListSectionProxy *section = [_sections objectAtIndex:sectionIndex];
